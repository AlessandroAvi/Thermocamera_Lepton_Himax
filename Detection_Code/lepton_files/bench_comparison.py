...
class YoloClass: 
    ...
    video_bench = "../Videos/Balcone/Lepton.mp4"
...
# Generating objects 
yolov3_ON = YoloClass("Yolo V3 - Cuda ON" , "./yolov3/yolov3_testing.cfg", "./yolov3/yolov3_training_last_lepton.weights", True, plot_colors[0])
yolov3_tiny_3l_ON = YoloClass("Yolo V3 tiny 3l - Cuda ON", "./yolov3_tiny_3l/yolov3_training.cfg", "./yolov3_tiny_3l/yolov3_training_last.weights", True, plot_colors[1])
yolov4_ON = YoloClass("Yolo V4 - Cuda ON", "./yolov4/yolov4_training.cfg", "./yolov4/yolov4_training_last.weights", True, plot_colors[2])
yolov4_tiny_3l_ON = YoloClass("Yolo V4 tiny 3l - Cuda ON", "./yolov4_tiny_3l/yolov3_training.cfg", "./yolov4_tiny_3l/yolov3_training_final.weights", True, plot_colors[4])
 
yolov3_OFF = YoloClass("Yolo V3 - Cuda OFF" , "./yolov3/yolov3_testing.cfg", "./yolov3/yolov3_training_last_lepton.weights", False, plot_colors[0])
yolov3_tiny_3l_OFF = YoloClass("Yolo V3 tiny 3l - Cuda OFF", "./yolov3_tiny_3l/yolov3_training.cfg", "./yolov3_tiny_3l/yolov3_training_last.weights", False, plot_colors[1])
yolov4_OFF = YoloClass("Yolo V4 - Cuda OFF", "./yolov4/yolov4_training.cfg", "./yolov4/yolov4_training_last.weights", False, plot_colors[2])
yolov4_tiny_3l_OFF = YoloClass("Yolo V4 tiny 3l - Cuda OFF", "./yolov4_tiny_3l/yolov3_training.cfg", "./yolov4_tiny_3l/yolov3_training_final.weights", False, plot_colors[4])

# Populating vector of objects 
classesVec = [] 
classesVec.append(yolov3_ON)
classesVec.append(yolov3_tiny_3l_ON)
classesVec.append(yolov4_ON)
classesVec.append(yolov4_tiny_3l_ON)
classesVec.append(yolov3_OFF)
classesVec.append(yolov3_tiny_3l_OFF)
